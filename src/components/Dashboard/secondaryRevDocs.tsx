...
function SecondaryRevDocModal({docsId}: Props_) {
  ...
  const handleSubmit = (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = axiosAPI.put(`/update/secondaryReviewerDocs/${docsId}`, filesData);
              ...
              <div className="px-6 py-6 lg:px-8">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mt-1">
                        ...
                        inputName="gapAnalysis"
                        containerClass="w-full sm:pr-4"
                        disable={false}
                        handleFileChange={(file: any) => handleFileChange(file, "gapAnalysis")}
                        />
                    </div>
                    <div>
                        <FileUpload
                        labelClass="text-white text-sm font-normal "
                        labelName="2. Risk assessment"
                        inputType="file"
                        inputClass="relative ml-3 block w-full min-w-0 flex-auto rounded border border-solid border-white px-3 py-[0.32rem] text-base font-normal text-neutral-700 transition duration-300 ease-in-out file:-mx-3 file:-my-[0.32rem] file:overflow-hidden file:rounded-none file:border-0 file:border-solid file:border-inherit file:bg-neutral-100 file:px-3 file:py-[0.32rem] file:text-neutral-700 file:transition file:duration-150 file:ease-in-out file:[border-inline-end-width:1px] file:[margin-inline-end:0.75rem] hover:file:bg-neutral-200 focus:border-primary focus:text-neutral-700 focus:shadow-te-primary focus:outline-none "
                        inputName="riskAssessment"
                        containerClass="w-full sm:pr-4"
                        disable={false}
                        handleFileChange={(file: any) => handleFileChange(file, "riskAssessment")}
                        />
                    </div>
                    <div className="mt-1">
                        <FileUpload
                        labelClass="text-white text-sm font-normal "
                        labelName="3. Risk Mitigation Report"
                        inputType="file"
                        inputClass="relative ml-3 block w-full min-w-0 flex-auto rounded border border-solid border-white px-3 py-[0.32rem] text-base font-normal text-neutral-700 transition duration-300 ease-in-out file:-mx-3 file:-my-[0.32rem] file:overflow-hidden file:rounded-none file:border-0 file:border-solid file:border-inherit file:bg-neutral-100 file:px-3 file:py-[0.32rem] file:text-neutral-700 file:transition file:duration-150 file:ease-in-out file:[border-inline-end-width:1px] file:[margin-inline-end:0.75rem] hover:file:bg-neutral-200 focus:border-primary focus:text-neutral-700 focus:shadow-te-primary focus:outline-none "
                        inputName="riskMitigation"
                        containerClass="w-full sm:pr-4"
                        disable={false}
                        handleFileChange={(file: any) => handleFileChange(file, "riskMitigation")}
                        />
                    </div>
                    <div>
                        <FileUpload
                        labelClass="text-white text-sm font-normal "
                        labelName="4. Incidence Response"
                        inputType="file"
                        inputClass="relative ml-3 block w-full min-w-0 flex-auto rounded border border-solid border-white px-3 py-[0.32rem] text-base font-normal text-neutral-700 transition duration-300 ease-in-out file:-mx-3 file:-my-[0.32rem] file:overflow-hidden file:rounded-none file:border-0 file:border-solid file:border-inherit file:bg-neutral-100 file:px-3 file:py-[0.32rem] file:text-neutral-700 file:transition file:duration-150 file:ease-in-out file:[border-inline-end-width:1px] file:[margin-inline-end:0.75rem] hover:file:bg-neutral-200 focus:border-primary focus:text-neutral-700 focus:shadow-te-primary focus:outline-none "
                        inputName="incidenceRes"
                        containerClass="w-full sm:pr-4"
                        disable={false}
                        handleFileChange={(file: any) => handleFileChange(file, "incidenceRes")}
                        />
                    </div>
                    <div className='w-full sm:pr-4'>
                        <label htmlFor="emptraining" className="text-white text-sm font-normal ">5. Employee training link</label>
                        <input type="text" 
                        className="relative ml-3 block w-full min-w-0 flex-auto rounded border border-solid border-white px-3 py-[0.32rem] text-base font-normal text-neutral-700 transition duration-300 ease-in-out file:-mx-3 file:-my-[0.32rem] file:overflow-hidden file:rounded-none file:border-0 file:border-solid file:border-inherit file:bg-neutral-100 file:px-3 file:py-[0.32rem] file:text-neutral-700 file:transition file:duration-150 file:ease-in-out file:[border-inline-end-width:1px] file:[margin-inline-end:0.75rem] hover:file:bg-neutral-200 focus:border-primary focus:text-neutral-700 focus:shadow-te-primary focus:outline-none" 
                        placeholder='training link'
                        onChange={(e:any) => setFilesData({
                            ...filesData,
                            empTraining: e.target.value,
                          })}/>
                    </div>
                </div>
...
export default SecondaryRevDocModal;