...
function FinalRevDocModal({docsId}: Props_) {
  ...
  const handleSubmit = (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
        const response = axiosAPI.put(`/update/updateDpp/${docsId}`, filesData);
  ...
  const handleFileChange = async (file: File, fieldName: string) => {
    ...
    setFilesData({
          ...filesData,
          dataProtectPolicies: JSON.stringify(json.secure_url), // Update the specified field name with the result
        });
}
              ...
              <div className="px-6 py-6 lg:px-8">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mt-1">
                        ...
                        labelName="1. Data Protection Policies"
                        inputType="file"
                        ...
                        inputName="dataProtectPolicies"
                        containerClass="w-full sm:pr-4"
                        disable={false}
                        handleFileChange={(file: any) => handleFileChange(file, "dataProtectPolicies")}
                        />
                    </div>
...
export default FinalRevDocModal;