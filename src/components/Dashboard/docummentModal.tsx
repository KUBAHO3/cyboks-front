              ...
              <div className="px-6 py-6 lg:px-8">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mt-1">
                        ...
                        inputName="letterToCeo"
                        containerClass="w-full sm:pr-4"
                        disable={false}
                        handleFileChange={(file: any) => handleFileChange(file, "letterToCeo")}
                        />
                    </div>
                    <div>
                        <FileUpload
                        labelClass="text-white text-sm font-normal "
                        labelName="2. Certificate of Incorporation"
                        inputType="file"
                        inputClass="relative ml-3 block w-full min-w-0 flex-auto rounded border border-solid border-white px-3 py-[0.32rem] text-base font-normal text-neutral-700 transition duration-300 ease-in-out file:-mx-3 file:-my-[0.32rem] file:overflow-hidden file:rounded-none file:border-0 file:border-solid file:border-inherit file:bg-neutral-100 file:px-3 file:py-[0.32rem] file:text-neutral-700 file:transition file:duration-150 file:ease-in-out file:[border-inline-end-width:1px] file:[margin-inline-end:0.75rem] hover:file:bg-neutral-200 focus:border-primary focus:text-neutral-700 focus:shadow-te-primary focus:outline-none "
                        inputName="certIncorporation"
                        containerClass="w-full sm:pr-4"
                        disable={false}
                        handleFileChange={(file: any) => handleFileChange(file, "certIncorporation")}
                        />
                    </div>
                    <div>
                        <FileUpload
                        ...
                        containerClass="w-full sm:pr-4"
                        disable={false}
                        handleFileChange={(file: any) => handleFileChange(file, "dpoID")}
                        />
                    </div>
                    <div>
                        <FileUpload
                        labelClass="text-white text-sm font-normal "
                        labelName="4. Application form"
                        inputType="file"
                        inputClass="relative ml-3 block w-full min-w-0 flex-auto rounded border border-solid border-white px-3 py-[0.32rem] text-base font-normal text-neutral-700 transition duration-300 ease-in-out file:-mx-3 file:-my-[0.32rem] file:overflow-hidden file:rounded-none file:border-0 file:border-solid file:border-inherit file:bg-neutral-100 file:px-3 file:py-[0.32rem] file:text-neutral-700 file:transition file:duration-150 file:ease-in-out file:[border-inline-end-width:1px] file:[margin-inline-end:0.75rem] hover:file:bg-neutral-200 focus:border-primary focus:text-neutral-700 focus:shadow-te-primary focus:outline-none "
                        inputName="appForm"
                        containerClass="w-full sm:pr-4"
                        disable={false}
                        handleFileChange={(file: any) => handleFileChange(file, "appForm")}
                        />
                    </div>
                    <div>
                        <FileUpload
                        labelClass="text-white text-sm font-normal "
                        labelName="5. Registration Licence"
                        inputType="file"
                        inputClass="relative ml-3 block w-full min-w-0 flex-auto rounded border border-solid border-white px-3 py-[0.32rem] text-base font-normal text-neutral-700 transition duration-300 ease-in-out file:-mx-3 file:-my-[0.32rem] file:overflow-hidden file:rounded-none file:border-0 file:border-solid file:border-inherit file:bg-neutral-100 file:px-3 file:py-[0.32rem] file:text-neutral-700 file:transition file:duration-150 file:ease-in-out file:[border-inline-end-width:1px] file:[margin-inline-end:0.75rem] hover:file:bg-neutral-200 focus:border-primary focus:text-neutral-700 focus:shadow-te-primary focus:outline-none "
                        inputName="regLicence"
                        containerClass="w-full sm:pr-4"
                        disable={false}
                        handleFileChange={(file: any) => handleFileChange(file, "regLicence")}
                        />
                    </div>
                    <div>
                        <FileUpload
                        labelClass="text-white text-sm font-normal "
                        labelName="6. Legal Institution"
                        inputType="file"
                        inputClass="relative ml-3 block w-full min-w-0 flex-auto rounded border border-solid border-white px-3 py-[0.32rem] text-base font-normal text-neutral-700 transition duration-300 ease-in-out file:-mx-3 file:-my-[0.32rem] file:overflow-hidden file:rounded-none file:border-0 file:border-solid file:border-inherit file:bg-neutral-100 file:px-3 file:py-[0.32rem] file:text-neutral-700 file:transition file:duration-150 file:ease-in-out file:[border-inline-end-width:1px] file:[margin-inline-end:0.75rem] hover:file:bg-neutral-200 focus:border-primary focus:text-neutral-700 focus:shadow-te-primary focus:outline-none "
                        inputName="legalInst"
                        containerClass="w-full sm:pr-4"
                        disable={false}
                        handleFileChange={(file: any) => handleFileChange(file, "legalInst")}
                        />
                    </div>
                    <div>
                        <FileUpload
                        labelClass="text-white text-sm font-normal "
                        labelName="7. Represantation contract"
                        inputType="file"
                        inputClass="relative ml-3 block w-full min-w-0 flex-auto rounded border border-solid border-white px-3 py-[0.32rem] text-base font-normal text-neutral-700 transition duration-300 ease-in-out file:-mx-3 file:-my-[0.32rem] file:overflow-hidden file:rounded-none file:border-0 file:border-solid file:border-inherit file:bg-neutral-100 file:px-3 file:py-[0.32rem] file:text-neutral-700 file:transition file:duration-150 file:ease-in-out file:[border-inline-end-width:1px] file:[margin-inline-end:0.75rem] hover:file:bg-neutral-200 focus:border-primary focus:text-neutral-700 focus:shadow-te-primary focus:outline-none "
                        inputName="repContract"
                        containerClass="w-full sm:pr-4"
                        disable={false}
                        handleFileChange={(file: any) => handleFileChange(file, "repContract")}
                        />
                    </div>
                    </div>
