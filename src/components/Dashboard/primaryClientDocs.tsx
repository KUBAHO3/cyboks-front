...
function PrimaryClientDocModal({docsId}: Props_) {
  ...
  const handleSubmit = (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = axiosAPI.put(`/update/secondaryClientDocs/${docsId}`, filesData);
            ...
            <button
              ...
              <div className="px-6 py-6 lg:px-8">
                <h3 className="mb-4 text-xl font-medium text-white dark:text-white">
                  Add a Data mapping questionaire
                </h3>
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mt-1">
                        ...
                        labelName="1. Filled data mapping questionaire"
                        inputType="file"
...
export default PrimaryClientDocModal;