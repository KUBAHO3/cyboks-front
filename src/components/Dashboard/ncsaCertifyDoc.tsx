...
function NcsaCertifyModal({docsId}: Props_) {
  ...
  const handleSubmit = (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
        const response = axiosAPI.put(`/update/certify/${docsId}`, filesData);
  ...
  const handleFileChange = async (file: File, fieldName: string) => {
    ...
    setFilesData({
          ...filesData,
          certificate: JSON.stringify(json.secure_url), // Update the specified field name with the result
        });
}
              ...
              <div className="px-6 py-6 lg:px-8">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mt-1">
                        ...
                        labelName="1. Upload Certificate"
                        inputType="file"
                        ...
                        disable={false}
                        handleFileChange={(file: any) => handleFileChange(file, "certificate")}
                        />
                    </div>
                    <div className='w-full sm:pr-4'>
                        <label htmlFor="emptraining" className="text-white text-sm font-normal ">2. Certificate End date</label>
                        <input type="date" 
...
export default NcsaCertifyModal;